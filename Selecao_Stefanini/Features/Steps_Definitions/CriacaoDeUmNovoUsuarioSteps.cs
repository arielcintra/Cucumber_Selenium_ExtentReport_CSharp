...
namespace Selecao_Stefanini.Features.Steps_Definitions
{
    ...
    public class CriacaoDeUmNovoUsuarioSteps
    {
        ...
        {
            _la.InserirEmailNovoCadastro("w@teste.com.br");
        }
        ...
        public void ThenValidoQueOsMeusDadosCadastradosEstaoCorretos()
        {
            ...
            _ca.ValidoDadosCadastradosPersonal("http://automationpractice.com/index.php?controller=identity", "Ariel", "Cintra", "w@teste.com.br");
            _driver.Close();
        }
    }
}
